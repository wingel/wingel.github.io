...
carrying it around.  If I were to break it I can afford a new one.
Being able to run the scope off the battery is also a real plus in
some situations.  Despite all its fault the OWON has somehow ended up
being up the scope I use most of the time.
